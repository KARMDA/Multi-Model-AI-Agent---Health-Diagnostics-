            ...
            >
                <div className="glass-card rounded-2xl p-8 backdrop-blur-xl border border-white/10 shadow-2xl">
                    <div className="text-center mb-8">
                        ...
                        <h2 className="text-3xl font-display font-bold mb-2 bg-gradient-to-r from-white to-white/60 bg-clip-text text-transparent">Welcome Back</h2>
                        <p className="text-secondary">Enter your credentials to access the workspace</p>
                    </div>
                    ...
                    <div className="mt-8 text-center text-sm text-secondary">
                        ...
                        <Link to="/signup" className="text-primary hover:text-primaryDark transition-colors font-medium">
                            Create Account
                        </Link>
                    </div>
                </div>
